...
const char* FileExtensionToMimeType(const char* ext) {
  ...
  if (!strcmp(ext, "config"))
    return "application/xml";
  if (!strcmp(ext, "contact"))
    return "text/x-ms-contact";
  if (!strcmp(ext, "coverage"))
    return "application/xml";
  if (!strcmp(ext, "cpio"))
  ...
  if (!strcmp(ext, "cs"))
    return "text/plain";
  if (!strcmp(ext, "csdproj"))
    return "text/plain";
  if (!strcmp(ext, "csh"))
    return "application/x-csh";
  if (!strcmp(ext, "csproj"))
    return "text/plain";
  if (!strcmp(ext, "css"))
    return "text/css";
  if (!strcmp(ext, "csv"))
  ...
  if (!strcmp(ext, "dat"))
    return "application/octet-stream";
  if (!strcmp(ext, "datasource"))
    return "application/xml";
  if (!strcmp(ext, "dbproj"))
    return "text/plain";
  if (!strcmp(ext, "dcr"))
  ...
  if (!strcmp(ext, "exe"))
    return "application/octet-stream";
  if (!strcmp(ext, "exe.config"))
    return "text/xml";
  if (!strcmp(ext, "fdf"))
    return "application/vnd.fdf";
  if (!strcmp(ext, "fif"))
    return "application/fractals";
  if (!strcmp(ext, "filters"))
    return "application/xml";
  if (!strcmp(ext, "fla"))
    return "application/octet-stream";
  if (!strcmp(ext, "flac"))
  ...
  if (!strcmp(ext, "flv"))
    return "video/x-flv";
  if (!strcmp(ext, "fsscript"))
    return "application/fsharp-script";
  if (!strcmp(ext, "fsx"))
    return "application/fsharp-script";
  if (!strcmp(ext, "generictest"))
    return "application/xml";
  if (!strcmp(ext, "gif"))
    return "image/gif";
  if (!strcmp(ext, "gpx"))
  ...
  if (!strcmp(ext, "manifest"))
    return "application/x-ms-manifest";
  if (!strcmp(ext, "map"))
    return "text/plain";
  if (!strcmp(ext, "master"))
    return "application/xml";
  if (!strcmp(ext, "mbox"))
  ...
  if (!strcmp(ext, "pict"))
    return "image/pict";
  if (!strcmp(ext, "pkgdef"))
    return "text/plain";
  if (!strcmp(ext, "pkgundef"))
    return "text/plain";
  if (!strcmp(ext, "pko"))
  ...
  if (!strcmp(ext, "rvt"))
    return "application/octet-stream";
  if (!strcmp(ext, "ruleset"))
    return "application/xml";
  if (!strcmp(ext, "s"))
    return "text/plain";
  if (!strcmp(ext, "safariextz"))
  ...
  if (!strcmp(ext, "sea"))
    return "application/octet-stream";
  if (!strcmp(ext, "searchConnector-ms"))
  ...
  if (!strcmp(ext, "srf"))
    return "text/plain";
  if (!strcmp(ext, "SSISDeploymentManifest"))
    return "text/xml";
  if (!strcmp(ext, "ssm"))
  ...
  if (!strcmp(ext, "testrunconfig"))
    return "application/xml";
  if (!strcmp(ext, "testsettings"))
    return "application/xml";
  if (!strcmp(ext, "tex"))
  ...
  if (!strcmp(ext, "vb"))
    return "text/plain";
  if (!strcmp(ext, "vbdproj"))
    return "text/plain";
  if (!strcmp(ext, "vbk"))
    return "video/mpeg";
  if (!strcmp(ext, "vbproj"))
    return "text/plain";
  if (!strcmp(ext, "vbs"))
    return "text/vbscript";
  if (!strcmp(ext, "vcf"))
    return "text/x-vcard";
  if (!strcmp(ext, "vcproj"))
    return "application/xml";
  if (!strcmp(ext, "vcs"))
    return "text/plain";
  if (!strcmp(ext, "vcxproj"))
    return "application/xml";
  if (!strcmp(ext, "vddproj"))
    return "text/plain";
  if (!strcmp(ext, "vdp"))
    return "text/plain";
  if (!strcmp(ext, "vdproj"))
    return "text/plain";
  if (!strcmp(ext, "vdx"))
    return "application/vnd.ms-visio.viewer";
  if (!strcmp(ext, "vml"))
    return "text/xml";
  if (!strcmp(ext, "vscontent"))
    return "application/xml";
  if (!strcmp(ext, "vsct"))
    return "text/xml";
  if (!strcmp(ext, "vsd"))
  ...
  if (!strcmp(ext, "vsixlangpack"))
    return "text/xml";
  if (!strcmp(ext, "vsixmanifest"))
    return "text/xml";
  if (!strcmp(ext, "vsmdi"))
    return "application/xml";
  if (!strcmp(ext, "vspscc"))
    return "text/plain";
  if (!strcmp(ext, "vss"))
    return "application/vnd.visio";
  if (!strcmp(ext, "vsscc"))
    return "text/plain";
  if (!strcmp(ext, "vssettings"))
    return "text/xml";
  if (!strcmp(ext, "vssscc"))
    return "text/plain";
  if (!strcmp(ext, "vst"))
    return "application/vnd.visio";
  if (!strcmp(ext, "vstemplate"))
    return "text/xml";
  if (!strcmp(ext, "vsto"))
  ...
  if (!strcmp(ext, "wlpginstall"))
    return "application/x-wlpg-detect";
  if (!strcmp(ext, "wlpginstall3"))
